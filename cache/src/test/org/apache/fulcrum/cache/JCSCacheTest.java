...
public class JCSCacheTest extends BaseUnitTest
{
    ...
    protected void setUp() throws Exception
    {
        ...
        try
        {
            this.globalCache = (GlobalCacheService) this
                    .lookup(GlobalCacheService.ROLE + "_JCS");
        }
    ...
    public void testObjectCount() throws Exception
    {
        ...
        CachedObject cacheObject = new CachedObject("This is a test",
                expireTime);
        assertNotNull("Failed to create a cachable object", cacheObject);
        this.globalCache.addObject("testObjectCount", cacheObject);
    ...
    /**
     * Verfy a refreshable object will refreshed in the following cases: - The
     * object is retrieved via getObject an it is stale. - The object is
    ...
    public void testRefreshableObject() throws Exception
    {
        ...
        assertNotNull("Failed to create a cachable object", cacheObject);
        long addTime = System.currentTimeMillis();
        this.globalCache.addObject("refreshableObject", cacheObject);
        // Try to get un-expired object
        try
        {
            retrievedObject = this.globalCache.getObject("refreshableObject");
            assertNotNull("Did not retrieved a cached object", retrievedObject);
            assertEquals("Did not retrieved correct cached object",
                    cacheObject, retrievedObject);
        }
        ...
        for (int i = 0; i < 100; i++)
        {
            ...
            {
                retrievedObject = null;
                retrievedObject = this.globalCache
                        .getObject("refreshableObject");
                assertNotNull("Did not retrieved a cached object, after sleep",
                        retrievedObject);
                assertNotNull("Cached object has no contents, after sleep.",
    ...
    public void testRefreshableTimeToLive() throws Exception
    {
        ...
        long timeout = getTestExpireTime() - 0;
